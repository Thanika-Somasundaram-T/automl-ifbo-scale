"""
Plot NLL/MSE breakdown by hyperparameter (LR and WD) for LINEAR-normalized contexts.
Epochs: 15, 50, 90
"""
import os
import json
...
EPOCH_COLORS = {15: '#e57373', 50: '#64b5f6', 90: '#81c784'}

# Contexts to analyze
CONTEXTS_TO_PLOT = [
    {"name": "[64, 32, 24, 18, 16, 8]", "ablation": "[64_32_24_18_16_8]"},
