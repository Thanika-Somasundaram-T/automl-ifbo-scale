"""
HTML analysis tables for LINEAR-normalized hidden dimension.
Generates tables for epochs 15, 50, 90.
Three-tier highlighting: light for column, dark for table, black border for global.
"""
import os
import json
import numpy as np
...
ABLATIONS_LIST = [
    ...
    "[64_32_24]", "[64_32_24_18]", "[64_32_24_18_16]",
    "[64_32_24_18_16_8]", "[64_32_24_18_16_8_4]"
]
...
def main():
    ...
    # First pass: collect global best/worst
    global_nlls = []
    global_mses = []
    ...
    html_content = [f"<html><head><title>Linear-Normalized Analysis</title>{style}</head><body><div class='container'>"]
    html_content.append("<h1>FT-PFN Analysis (Linear-Normalized Hidden Dim)</h1>")
    html_content.append("<p>Observation epochs: 15, 50, 90. <b>NLL</b> and <b>MSE</b> (lower=better).</p>")
    html_content.append("<p><small>🟩 Dark green = table best | 🟥 Dark red = table worst | Light colors = column best/worst | Black border = global best/worst</small></p>")
