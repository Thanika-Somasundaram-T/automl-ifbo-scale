...
# Configuration
RESULTS_DIR = "results_64"
EPOCHS_LIST = [20]
ABLATIONS_LIST = [
    "[4]", "[8]", "[16]", "[24]", "[32]",
    "[8_4]", "[16_4]", "[24_4]", "[32_4]", "[16_8]",
    "[24_8]", "[32_8]", "[24_16]", "[32_16]", "[32_24]",
    "[16_8_4]", "[24_8_4]", "[32_8_4]", "[24_16_4]", "[32_16_4]",
    "[32_24_4]", "[24_16_8]", "[32_16_8]", "[32_24_8]", "[32_24_16]",
    "[24_16_8_4]", "[32_16_8_4]", "[32_24_8_4]", "[32_24_16_4]", "[32_24_16_8]",
    "[32_24_16_8_4]"
]
...
def main():
    ...
    metrics = load_json(os.path.join(RESULTS_DIR, "results_hd64.json"))
    if not metrics:
    ...
    fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(24, 12), gridspec_kw={'height_ratios': [6, 1]})
    ...
    ax1.axhline(y=baseline_median, color='#81c784', linestyle='--', linewidth=2)
    ...
    # Save
    output_path = "analysis_64/nll_mse_boxplot_ep20.png"
