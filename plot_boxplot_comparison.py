...
EPOCH_COLORS = {15: '#e57373', 50: '#64b5f6', 90: '#81c784'}  # Red, Blue, Green (softer)
...
def main():
    ...
    # Create figure with two subplots (no sharex - show x labels on both)
    ...
    # Save
    output_path = "analysis_outputs/nll_mse_boxplot_comparison.png"
