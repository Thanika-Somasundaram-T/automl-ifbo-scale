...
# Configuration
RESULTS_DIR = "results_32"
EPOCHS_LIST = [5]
ABLATIONS_LIST = [
    "[4]", "[8]", "[16]", "[24]",
    "[8_4]", "[16_8]", "[16_4]", "[24_16]", "[24_8]", "[24_4]",
    "[16_8_4]", "[24_8_4]", "[24_16_8]", "[24_16_4]",
    "[24_16_8_4]"
]
...
def main():
    ...
    metrics = load_json(os.path.join(RESULTS_DIR, "results_hd32.json"))
    if not metrics:
    ...
    # Save
    output_path = "analysis_32/nll_mse_boxplot_ep5.png"
