...
# Configuration
RESULTS_DIR = "sanity_check"
EPOCHS_LIST = [20]
ABLATIONS_LIST = ["[32]", "[128]", "[128_32]"]
...
def main():
    ...
    for epoch in EPOCHS_LIST:
        ...
        for context_name in ABLATIONS_LIST:
            pred_filename = f"interpolation_pred64_{context_name}_ep{epoch}.json"
    ...
    fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(15, 8), gridspec_kw={'height_ratios': [6, 1]})
    ...
    # Save
    output_path = "sanity_check/nll_mse_boxplot_ep20.png"
